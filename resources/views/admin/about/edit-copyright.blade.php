        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Copyright</div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        <div class="card-head">
                            <header>Update Copyright</header>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-lg-12 p-t-20">
                                <div class="mdl-textfield mdl-js-textfield txt-full-width">
                                    <textarea class="mdl-textfield__input" rows="4" id="article_ckeditor" name="copyright">{{$About->copyright}}</textarea>
                                    <label class="mdl-textfield__label" for="text7">Copyright</label>
                                </div>
                            </div>
