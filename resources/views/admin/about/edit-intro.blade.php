        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        <div class="card-head">
                            <header>Update Introduction</header>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-lg-12 p-t-20">
                                <div class="mdl-textfield mdl-js-textfield txt-full-width">
                                    <textarea class="mdl-textfield__input" rows="4" id="article_ckeditor" name="introduction">{{$About->introduction}}</textarea>
                                    <label class="mdl-textfield__label" for="text7">Introduction</label>
                                </div>
                            </div>
