...
<head>
	...
	<!-- gallery -->
	<link href="{{asset('admins/assets/plugins/light-gallery/css/lightgallery.css')}}" rel="stylesheet">
	<!-- Template Styles -->
...
<body
	...
	<!-- gallery -->
	<script src="{{asset('admins/assets/plugins/light-gallery/js/lightgallery-all.js')}}"></script> <!-- Light Gallery Plugin Js -->
	<script src="{{asset('admins/assets/plugins/light-gallery/js/image-gallery.js')}}"></script>
	<!-- end js include path -->
