        ...
        <div class="row">
            <div class="col-xxl-12 col-xl-12 col-lg-12 lg-mb-30">
                <div class="blog__details-left">
                    <img style="border-radius:10px" src="{{url('/')}}/uploads/images/hotels/Restaurant-main.jpeg" alt="">
                    <div class="blog__details-left-meta">
                        <ul>
                            <li><a href="#"><i class="fal fa-user"></i>By - Admin</a></li>
                            <li><a href="#"><i class="fal fa-calendar-alt"></i>{{date('d', strtotime($blogs->created_at))}}, {{date('M', strtotime($blogs->created_at))}} {{date('Y', strtotime($blogs->created_at))}}</a></li>
                            <li><a href="https://goo.gl/maps/oddymmdLVoFDvv9A8"><i class="fal fa-map-marker"></i>Villa Serene Hotel</a></li>
                        </ul>
                    </div>
                    <h3 class="mb-20">{{$blogs->title}}</h3>
                    <p class="mb-25">
                    ...
                    <div class="blog__details-left-box">
                        <div class="blog__details-left-box-icon">
                            <img src="{{asset('theme/assets/img/icon/quote.png')}}" alt="">
                        </div>
                        <p>
